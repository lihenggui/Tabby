...
val TabbyIcons.BaselineSettings: ImageVector
  get() {
    if (_BaselineSettings != null) {
      return _BaselineSettings!!
    }
    _BaselineSettings =
      ImageVector.Builder(
          name = "BaselineSettings",
          defaultWidth = 24.dp,
          defaultHeight = 24.dp,
          viewportWidth = 24f,
          viewportHeight = 24f,
...
@Suppress("ObjectPropertyName") private var _BaselineSettings: ImageVector? = null
